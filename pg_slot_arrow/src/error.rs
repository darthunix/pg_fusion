...
pub enum ConfigError {
    ...
    #[error("dropped attributes are not supported in pg_slot_arrow v2 (column {index})")]
    ...
    #[error("invalid page_arrow_layout block: {0}")]
...
pub enum EncodeError {
    ...
    #[error("page_arrow_layout write failed: {0}")]
    Layout(#[from] LayoutError),
}
