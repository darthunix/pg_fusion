...
use rmp::decode::{
    read_bool, read_f32, read_f64, read_i16, read_i32, read_i64, read_str_len, read_u8, RmpRead,
};
use rmp::encode::{
...
#[inline]
pub fn write_scalar_value(stream: &mut impl ByteStream, value: &ScalarValue) -> Result<()> {
    let write_null = |mut stream: &mut dyn ByteStream| -> Result<()> {
...
#[inline]
pub fn read_scalar_value(stream: &mut impl ByteStream) -> Result<ScalarValue> {
