...
pub enum MetricId {
    ...
    ScanPostgresReadNs,
    ScanArrowEncodeNs,
    ScanAppendPrecheckNs,
    ScanAppendPrecheckTotal,
    ScanTupledescCheckNs,
    ScanTupledescCheckTotal,
    ScanSlotDeformNs,
    ScanSlotDeformTotal,
    ScanCellExtractNs,
    ScanCellsExtractedTotal,
    ScanVarlenaDetoastNs,
    ScanVarlenaDetoastTotal,
    ScanPageWriteNs,
    ScanRowEncodeOuterNs,
    ScanRowEncodeOuterTotal,
    ScanAppendStatusNs,
    ScanAppendStatusTotal,
    ScanEncodeUnclassifiedNs,
    ScanFullPagesTotal,
    ScanEofPagesTotal,
    ScanPagesSentTotal,
    ScanBytesSentTotal,
...
pub const METRIC_DESCRIPTORS: [MetricDescriptor; METRIC_COUNT] = [
    ...
    MetricDescriptor {
        id: MetricId::ScanPostgresReadNs,
        component: "scan",
        metric: "scan_postgres_read_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanArrowEncodeNs,
        component: "scan",
        metric: "scan_arrow_encode_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanAppendPrecheckNs,
        component: "scan",
        metric: "scan_append_precheck_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanAppendPrecheckTotal,
        component: "scan",
        metric: "scan_append_precheck_total",
        kind: MetricKind::Counter,
        unit: MetricUnit::Count,
    },
    MetricDescriptor {
        id: MetricId::ScanTupledescCheckNs,
        component: "scan",
        metric: "scan_tupledesc_check_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanTupledescCheckTotal,
        component: "scan",
        metric: "scan_tupledesc_check_total",
        kind: MetricKind::Counter,
        unit: MetricUnit::Count,
    },
    MetricDescriptor {
        id: MetricId::ScanSlotDeformNs,
        component: "scan",
        metric: "scan_slot_deform_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanSlotDeformTotal,
        component: "scan",
        metric: "scan_slot_deform_total",
        kind: MetricKind::Counter,
        unit: MetricUnit::Count,
    },
    MetricDescriptor {
        id: MetricId::ScanCellExtractNs,
        component: "scan",
        metric: "scan_cell_extract_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanCellsExtractedTotal,
        component: "scan",
        metric: "scan_cells_extracted_total",
        kind: MetricKind::Counter,
        unit: MetricUnit::Count,
    },
    MetricDescriptor {
        id: MetricId::ScanVarlenaDetoastNs,
        component: "scan",
        metric: "scan_varlena_detoast_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanVarlenaDetoastTotal,
        component: "scan",
        metric: "scan_varlena_detoast_total",
        kind: MetricKind::Counter,
        unit: MetricUnit::Count,
    },
    MetricDescriptor {
        id: MetricId::ScanPageWriteNs,
        component: "scan",
        metric: "scan_page_write_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanRowEncodeOuterNs,
        component: "scan",
        metric: "scan_row_encode_outer_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanRowEncodeOuterTotal,
        component: "scan",
        metric: "scan_row_encode_outer_total",
        kind: MetricKind::Counter,
        unit: MetricUnit::Count,
    },
    MetricDescriptor {
        id: MetricId::ScanAppendStatusNs,
        component: "scan",
        metric: "scan_append_status_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
        id: MetricId::ScanAppendStatusTotal,
        component: "scan",
        metric: "scan_append_status_total",
        kind: MetricKind::Counter,
        unit: MetricUnit::Count,
    },
    MetricDescriptor {
        id: MetricId::ScanEncodeUnclassifiedNs,
        component: "scan",
        metric: "scan_encode_unclassified_ns",
        kind: MetricKind::Timer,
        unit: MetricUnit::Nanoseconds,
    },
    MetricDescriptor {
