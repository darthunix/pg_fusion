...
`arrow_layout` pages. If the CSV directory is absent, it falls back to a
deterministic q05-like synthetic fixture so the benchmark target still compiles
and runs without PostgreSQL.
