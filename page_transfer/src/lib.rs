//! Sans-IO page handoff protocol and page message wrappers over `page_pool`.
//!
//! `page_transfer` does not move page bytes through the transport. Instead, it
//! writes a message into a shared-memory page acquired from [`page_pool`] and
