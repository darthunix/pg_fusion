...
mod tests {
    ...
    // For wire tuple encode/decode roundtrip
    use pgrx::pg_sys::SysCacheIdentifier::TYPEOID;
    use protocol::tuple::{decode_wire_tuple, encode_wire_tuple, Field as F, PgAttrWire};
    ...
    fn wire_tuple_int4_text_roundtrip() {
        ...
        unsafe {
            ...
            // Decode and build Datums via the same logic as in result assembly
